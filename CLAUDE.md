...
## Run Information
- Mayhem Run: mayhemheroes/lexbor/css-tokenizer/1
- Git Commit: 6a0571986cca5ee0647648d0877973d0e35521e6
- Original Image: ghcr.io/mayhemheroes/lexbor:master
- Target Executable: Not specified
- CI URL: https://github.com:443/mayhemheroes/lexbor//actions/runs/4297266543
...
- Source code: `/rlenv/source/lexbor/`
...
RUN cp <build-artifact> Not specified

# 11. Permission Management (REQUIRED)
RUN chmod 766 Not specified
...
- `COPY . /rlenv/source/lexbor/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/lexbor/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 Not specified`
...
- [ ] Target executable in Dockerfile.rlenv: `Not specified`
- [ ] Target executable in build.sh: `Not specified`
- [ ] Target executable in metadata.json: `Not specified`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/lexbor/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/lexbor/fuzz
...
- Source copy: `COPY . /rlenv/source/lexbor/`
...
- Working directory: `cd /rlenv/source/lexbor/`
- No network access
